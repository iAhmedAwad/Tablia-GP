...
public class EditChiefActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                settings.setEnd_order_time(end.getText().toString());
                settings.setStart_order_time(start.getText().toString());
    ...
    */
    ...
    private void setProfileWidgets(ChefSettings chefSettings) {
        ...
        start.setText(String.valueOf(chefSettings.getChefAccountSettings().getStart_order_time()));
        end.setText(String.valueOf(chefSettings.getChefAccountSettings().getEnd_order_time()));
