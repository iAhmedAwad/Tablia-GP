package iti.team.tablia.CustomerAccount.Categories.Macaroni;
...
public   class MacaroniFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
      ...
      View view = inflater.inflate(R.layout.fragment_category, container, false);
        ...
        if(lang.equals("ar")) {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.MACARONI_AR);
        }else {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.MACARONI);
        }
