package iti.team.tablia.CustomerAccount.Categories.Soups;
...
import iti.team.tablia.util.Constants;
  ...
  public class SoupsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
      ...
      if(lang.equals("ar")) {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.SOUPS_AR);
      }else {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.SOUPS);
      }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      mViewModel.getCategoryItems(Constants.SOUPS, Constants.SOUPS_AR)
