package iti.team.tablia.CustomerAccount.Categories.MainDishes;
 ...
 public class MainDishesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
      ...
      View view = inflater.inflate(R.layout.fragment_category, container, false);
        ...
        if(lang.equals("ar")) {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.MAIN_DISHES_AR);
        }else {
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.MAIN_DISHES);
        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      mViewModel.getCategoryItems(Constants.MAIN_DISHES, Constants.MAIN_DISHES_AR)
