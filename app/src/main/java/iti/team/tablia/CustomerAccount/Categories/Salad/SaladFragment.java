package iti.team.tablia.CustomerAccount.Categories.Salad;
...
import iti.team.tablia.util.Constants;
  ...
  public class SaladFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
      ...
      if(lang.equals("ar")) {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.SALAD_AR);
      }else {
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Constants.SALAD);
      }
